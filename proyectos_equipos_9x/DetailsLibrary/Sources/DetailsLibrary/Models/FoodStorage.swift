...
class FoodStorage {
    ...
    private lazy var container: NSPersistentContainer = {
        ...
        /*guard
            let objectModelURL = Bundle.main.url(forResource: "FoodModel", withExtension: "xcdatamodeld"),
            let objectModel = NSManagedObjectModel(contentsOf: objectModelURL)
        else {
            fatalError("Failed to retrieve the object model")
        }
        
        let container = NSPersistentContainer(name: "FoodModel", managedObjectModel: objectModel)*/
