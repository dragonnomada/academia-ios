...
class SceneDelegate: UIResponder, UIWindowSceneDelegate, UINavigationControllerDelegate {
    ...
    private lazy var model: MyModel = {
        let model = MyModel()
        
        // TODO: Cargamos datos al modelo
        
        return model
    }()
    
    private lazy var viewModel: MyViewModel = {
        
        let viewModel = MyViewModel(model: self.model)
        
        // TODO: Configurar el View-Model
