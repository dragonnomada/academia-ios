...
//Calculando el promedio de 1000 mujeres MX CONCURRENTE

concurrentDispatch.async {
    print("---[CONCURRENTE] INICIO DE PROMEDIO DE MUJERES MX---")
...
//Calculando el promedio de 100 mujeres BR CONCURRENTE

concurrentDispatch.async {
    print("---[CONCURRENTE] INICIO DE PROMEDIO DE MUJERES BR---")
...
//Calculando el promedio de 500 mujeres AU CONCURRENTE
...
//Calculando el promedio de 50 mujeres ch CONCURRENTE

concurrentDispatch.async {
    print("---[CONCURRENTE] INICIO DE PROMEDIO DE MUJERES CH---")
